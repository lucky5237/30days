...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/OverlayController/OverlayController.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YHPhotoKit/YHPhotoKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YHPopupView/YHPopupView.framework"
